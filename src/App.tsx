...
function App() {
  ...
  useEffect(() => {
    ...
    document.documentElement.classList.toggle('font-inter', fontFamily === 'inter');
    document.documentElement.classList.toggle('font-poppins', fontFamily === 'poppins');
    document.documentElement.classList.toggle('font-roboto', fontFamily === 'roboto');
  }, [theme, fontFamily]);
