    ...
    >
      ...
      {[...Array(8)].map((_, i) => (
        <div
          ...
          style={{
            background: `radial-gradient(circle at center, rgba(${Math.random() * 255},${Math.random() * 255},255,0.3), transparent)`,
      ...
      >
        <div className="flex justify-center gap-6 mb-12">
          <motion.div
            ...
            whileHover={{ scale: 1.1, rotate: 5, boxShadow: '0 0 30px rgba(59, 130, 246, 0.5)' }}
          >
            <Code className="w-8 h-8 text-blue-400" />
          </motion.div>
          <motion.div
            className="hero-icon p-4 bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300"
            whileHover={{ scale: 1.1, rotate: -5, boxShadow: '0 0 30px rgba(168, 85, 247, 0.5)' }}
          >
            <Database className="w-8 h-8 text-purple-400" />
          </motion.div>
          <motion.div
            className="hero-icon p-4 bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300"
            whileHover={{ scale: 1.1, rotate: 5, boxShadow: '0 0 30px rgba(236, 72, 153, 0.5)' }}
          >
